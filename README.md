...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/venv-kernel-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14013&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/venv-kernel-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `venv-kernel` can be installed with:

```
conda install venv-kernel
```

It is possible to list all of the versions of `venv-kernel` available on your platform with:
